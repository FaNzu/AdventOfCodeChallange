...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day10.Part1.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day10, Part.Part1, Author.Anna);
