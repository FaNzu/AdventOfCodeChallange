...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day09.Part2.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day09, Part.Part2, Author.Anna);
        ...
        public override Task<string> Solve(string input)
        {
            ...
            var largestDistance = int.MinValue;
            foreach (var permutation in permutations)
            {
                ...
                if (distanceOfPermutation > largestDistance)
                    largestDistance = distanceOfPermutation;
            }
