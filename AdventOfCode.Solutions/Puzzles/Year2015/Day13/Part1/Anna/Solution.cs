...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day13.Part1.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day13, Part.Part1, Author.Anna);
