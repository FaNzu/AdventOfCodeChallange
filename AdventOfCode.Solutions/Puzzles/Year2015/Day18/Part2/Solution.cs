...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day18.Part2
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day18, Part.Part2, Author.Anna);
