...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day15.Part2.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day15, Part.Part2, Author.Anna);
        ...
        public override Task<string> Solve(string input)
        {
            ...
            var calorieCounts = new Dictionary<string, int>();
            ...
            foreach (var l in input.Split('\n'))
            {
                ...
                var calorieCount = int.Parse(split[10]);
                ...
                calorieCounts.Add(ingredient, calorieCount);
            }
            ...
            foreach (var distribution in distributions)
            {
                ...
                foreach (var (ingredient, teaspoons) in distribution)
                {
                    ...
                    totalCalorieCount += teaspoons * calorieCounts[ingredient];
                }
                ...
                if (totalCalorieCount == 500 && score > largestScore)
                    largestScore = score;
            }
