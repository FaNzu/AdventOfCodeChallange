...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day17.Part1.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day17, Part.Part1, Author.Anna);
