...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day11.Part2.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day11, Part.Part2, Author.Anna);

        public override Task<string> Solve(string input)
        {
            var password = IncrementPassword("cqjxxyzz");
