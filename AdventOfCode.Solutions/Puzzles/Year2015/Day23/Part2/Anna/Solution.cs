...
namespace AdventOfCode.Solutions.Puzzles.Year2015.Day23.Part2.Anna
{
    public class Solution : BaseSolution
    {
        public override SolutionMetadata Metadata => new(Year.Year2015, Day.Day23, Part.Part2, Author.Anna);
